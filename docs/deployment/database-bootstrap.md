...
For environments that must start with the current application records, this repository includes a database snapshot generated on 2026-06-12:

| File | Purpose |
|------|---------|
| `backend/database/snapshots/leadsy_full_structure_and_data_2026_06_12.sql` | Complete PostgreSQL structure + data archive for manual restore or audit. |
| `backend/database/snapshots/leadsy_deploy_data_2026_06_12.sql` | Public-schema application data used by the guarded Laravel import migration. |
