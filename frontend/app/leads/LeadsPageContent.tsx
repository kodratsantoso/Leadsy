...
export function LeadsPageContent({ initialIndustryId }: { initialIndustryId?: string } = {}) {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {industryFilter && (
        <div className="flex items-center justify-between gap-3 rounded-xl border border-[var(--brand)]/30 bg-[color-mix(in_oklch,var(--brand)_8%,transparent)] px-4 py-2.5 text-sm">
          ...
          <Table>
            <TableHead>
              <tr>
                ...
                <TableHeaderCell className="w-[90px]">Actions</TableHeaderCell>
              </tr>
            </TableHead>
            <TableBody>
              {isLoading ? (
