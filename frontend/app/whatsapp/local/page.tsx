...
export default function LocalWhatsAppPage() {
  ...
  return (
    <div className="space-y-6 p-6 max-w-5xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Local WhatsApp</h1>
        <p className="text-sm text-muted-foreground">
          Manage your local Baileys session, broadcast messages, and evaluate synced conversations using real-time AI.
        </p>
      </div>
