...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/settings/company",         icon: Building2,    label: "Company Settings", group: "System & Security" },
      { href: "/settings/workflows",       icon: GitBranch,    label: "Custom Workflows", group: "System & Security" },
