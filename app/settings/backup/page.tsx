    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-3"><Clock className="h-4 w-4 text-[var(--brand)]" /><h3 className="text-sm font-semibold">Backup Schedule</h3></div>
        ...
        <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-3"><HardDrive className="h-4 w-4 text-[var(--status-success)]" /><h3 className="text-sm font-semibold">Retention Policy</h3></div>
        ...
        <div className="sm:col-span-2 rounded-xl border border-border bg-card p-5 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2"><RefreshCw className="h-4 w-4 text-[var(--status-warning)]" /><h3 className="text-sm font-semibold">Recovery</h3></div>
