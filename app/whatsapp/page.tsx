          ...
          <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
            ...
            {session.status === "qr_ready" && session.qr_payload && (
              <div className="flex flex-col items-center gap-4">
                <div className="flex h-52 w-52 items-center justify-center rounded-2xl border border-border bg-white overflow-hidden p-2">
                  {/* Render QR from real Baileys payload */}
                  <img
